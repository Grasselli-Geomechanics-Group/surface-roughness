...
struct TIN_triangle_againstshear
{
	unsigned int index;
	...
	*/
	...
	TIN_triangle_againstshear(int index, arma::vec normal, double area) :
...
class TINBasedRoughness_againstshear
{
public:
	TINBasedRoughness_againstshear(const std::vector<double>& points, const std::vector<uint64_t>& triangles);
	TINBasedRoughness_againstshear(const std::vector<double>& points, const std::vector<uint64_t>& triangles, const std::vector<uint64_t>& selected_triangles);
