...
{
public:
	TINBasedRoughness_againstshear(Eigen::MatrixX3d points, Eigen::MatrixX3i triangles);
	TINBasedRoughness_againstshear(Eigen::MatrixX3d points, Eigen::MatrixX3i triangles, Eigen::ArrayXi selected_triangles);
...
private:
	...
	Eigen::ArrayXd delta_n_;
	Eigen::ArrayXd delta_star_n_;
